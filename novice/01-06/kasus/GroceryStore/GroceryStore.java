 ...
 * false assertion.
 * 
 * To compile, javac -d classes src/org/teckhooi/generics/GroceryStore.java
 * 
 * To execute, java -ea -cp classes org.teckhooi.generics.GroceryStore
 * 
...
public class GroceryStore {
     ...
     *
     * Note : List<Apple> is not a child of List<Fruit> though Apple inherits from
     * Fruit. It just does not work this way.
     */
